...
const NotificationHeader = ({
  ...
  <div
    className={`grid grid-cols-[1fr_220px_100px_150px] items-center gap-4 ${isDocuments ? 'pl-8' : 'px-1'} pb-1 pt-3`}
  >
...
const DocumentNotificationItem = ({
  ...
  return (
    <div className="grid grid-cols-[1fr_220px_100px_150px] gap-4 items-center py-2">
